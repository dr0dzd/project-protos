...
const file_user_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB8Z6github.com/dr0dzd/project-protos/proto_gen/user/userpbb\x06proto3"
