...
const file_task_proto_rawDesc = "" +
	...
	".task.Task\x120\n" +
	"\tListTasks\x12\n" +
	".task.Task\x1a\x17.task.ListTasksResponse\x12?\n" +
	"\n" +
	"UpdateTask\x12\x17.task.UpdateTaskRequest\x1a\x18.task.UpdateTaskResponse\x12?\n" +
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponseB2Z0github.com/dr0dzd/project-protos/proto/task;taskb\x06proto3"
...
var file_task_proto_depIdxs = []int32{
	...
	5,  // 12: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
