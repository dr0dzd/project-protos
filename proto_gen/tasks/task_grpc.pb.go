...
type TaskServiceClient interface {
	...
	ListTasks(ctx context.Context, in *Task, opts ...grpc.CallOption) (*ListTasksResponse, error)
...
func (c *taskServiceClient) ListTasks(ctx context.Context, in *Task, opts ...grpc.CallOption) (*ListTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TaskServiceServer interface {
	...
	// TODO: дописать ListTasks, UpdateTask, DeleteTask
	ListTasks(context.Context, *Task) (*ListTasksResponse, error)
...
func (UnimplementedTaskServiceServer) ListTasks(context.Context, *Task) (*ListTasksResponse, error) {
...
func _TaskService_ListTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).ListTasks(ctx, req.(*Task))
	}
	return interceptor(ctx, in, info, handler)
}
